...
*   A. Rowstron and P. Druschel, _Pastry: Scalable, distributed object location and routing for large-scale peer-to-peer systems_.  IFIP/ACM International Conference on Distributed Systems Platforms (Middleware), Heidelberg, Germany, pages 329-350, November, 2001. [[pdf](http://rowstron.azurewebsites.net/PAST/pastry.pdf)]

*   M. Castro, P. Druschel, Y. C. Hu, A. Rowstron, _Proximity neighbor selection in tree-based structured peer-to-peer overlays_.  Microsoft Technical Report MSR-TR-20032-52, 2003.  [[pdf.zip](http://freepastry.rice.edu/PAST/location-msrtr-2003-52.zip) | [ps.zip](http://freepastry.rice.edu/PAST/location-msrtr-2003-52.ps.zip) |[pdf](http://www.freepastry.org/PAST/location-msrtr-2003-52.pdf) |[ps](http://freepastry.rice.edu/PAST/location-msrtr-2003-52.ps)]

*   M. Castro, P. Druschel, A.-M. Kermarrec  and A. Rowstron, "_SCRIBE: A large-scale and decentralized application-level multicast infrastructure_", IEEE Journal on Selected Areas in Communications (JSAC) (Special issue on Network Support for Multicast Communications). 2002, to appear.  [[pdf](http://rowstron.azurewebsites.net/PAST/jsac.pdf)]

*   A. Rowstron and P. Druschel, "_Storage management and caching in PAST, a large-scale, persistent peer-to-peer storage utility_", 18th ACM SOSP'01, Lake Louise, Alberta, Canada, October 2001.  [[pdf](http://rowstron.azurewebsites.net/PAST/past-sosp.pdf)] (Corrected - erratum for original version: [[ps]](https://www.freepastry.org/PAST/sosp-erratum.ps))

*   F. Dabek, P. Druschel, B. Zhao, J. Kubiatowicz, and I. Stoica, "_Towards a Common API for Structured Peer-to-Peer Overlays_", 2nd IPTP'03, Berkeley, CA, February, 2003.  [[pdf](https://www.cs.rice.edu/~druschel/publications/kbr-api.pdf)]

*   Miguel Castro, Peter Druschel, Anne-Marie Kermarrec, Animesh Nandi, Antony Rowstron and Atul Singh, _SplitStream: High-bandwidth multicast in a cooperative environment._ In Proceedings of the 19th ACM Symposium on Operating Systems Principles (SOSP'03). Lake George, New York, October 2003. [[pdf](http://www.freepastry.org/PAST/SplitStream-results.pdf)]

*   Andreas Haeberlen, Jeff Hoye, Alan Mislove, and Peter Druschel, _Consistent Key Mapping in Structured Overlays._ Technical Report TR05-456, Department of Computer Science, Rice University, forthcoming. [[pdf](http://www.freepastry.org/papers/consistency.pdf)]
...
* `java rice.pastry.testing.HelloWorld`
